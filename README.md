...
This repository hosts the WebSphere and Liberty wiki, a collection of links to information about how to migrate your first WebSphere Application Server application to run on [Liberty](https://www.ibm.com/products/liberty).
...
- To **get feedback and contributions** from IBMers and WebSphere clients.
- To **prioritise creating missing information** (releasing internal information or creating from scratch) in appropriate formats.

## How to contribute

- If you spot a gap or inaccuracy in information, or just a comment, [raise an issue](https://github.com/WASdev/websphere-and-liberty/issues/new/choose). [*]
